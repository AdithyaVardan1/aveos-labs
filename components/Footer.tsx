    ...
    <footer className={styles.footer}>
      <div className={styles.top}>
        <div className={styles.brand}>
          <a className={styles.logo} href="#">AVEOS <span>•</span> LABS</a>
          <p>Elite AI laboratory building products and systems that give businesses a genuine edge.</p>
        </div>
        ...
        <div>
          ...
          <div className={styles.socials}>
            <a
              ...
              href="https://x.com/aveoslabs"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="X / Twitter"
            >
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff">
            ...
            <a
              className={styles.socialCircle}
              href="https://www.instagram.com/aveoslabs/"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottom}>
        <p>© 2026 Aveos Labs. All rights reserved.</p>
        <p><a href="mailto:hello@aveoslabs.com">hello@aveoslabs.com</a></p>
      </div>
    </footer>
  );
}
